...
class FlowerModule(LightningModule):
    def __init__(
        self,
        net: torch.nn.Module,
        ...
        self.test_auc = AUROC(task="multiclass", num_classes=102)
        self.test_cm = ConfusionMatrix(task="multiclass", num_classes=102)
    ...
    def test_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        self.log("test/cm", self.test_cm, on_step=False, on_epoch=True, prog_bar=False)
...
if __name__ == "__main__":
    _ = FlowerModule(None, None, None, None)
